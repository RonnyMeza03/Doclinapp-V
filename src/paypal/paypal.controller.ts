...
export class PaypalController {
  ...
  @Get(':idAuth0/create-order')
  async createOrder(@Param('idAuth0') idAuth0: string) {
    try {
      ...
      const order = {
        ...
        application_context: {
          ...
          user_action: 'PAY_NOW',
          return_url: `${HOST}/paypal/${encodedIdAuth0}/capture-order`,
  ...
  async captureOrder(
    ...
    try {
      ...
      if (respuesta.data.status === 'COMPLETED') {
        ...
        this.paypalService.create(originalIdAuth0, respuesta.data);
